...
Welcome to the official VSDinside Plugin SDK repository! Here you'll find various programming language templates and a complete development toolkit for creating VSDinside plugins. With our SDK, developers can easily create and publish their own VSDinside plugins.
...
Visit our [AI-Generated Documentation](https://deepwiki.com/VSDinside/VSDinside-Plugin-SDK) to get:
...
To quickly get started developing plugins using the templates in this repository, we recommend you check out the [AI-Generated Documentation](https://deepwiki.com/VSDinside/VSDinside-Plugin-SDK)
...
- 📧 Email: vsdinside@gmail.com
- 💡 Issues: [GitHub Issues](https://github.com/VSDinside/VSDinside-Plugin-SDK/issues)
- 🌐 Documentation: [https://sdk.key123.vip](https://sdk.key123.vip/en/)
- 🏪 Plugin Market: [Space Platform](https://space.key123.vip?software=StreamDock&client=VSDCraft&lang=en)
- 💬 Discord：[Join our community](https://discord.vsdinside.com/)

---

<div align="center">

Thank you for using VSDinside Plugin SDK! If you find this project helpful, please consider giving us a ⭐️
